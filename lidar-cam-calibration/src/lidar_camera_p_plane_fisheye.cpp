...
int main(int argc, char** argv) {
    ...
    FileStorage f_calib;
    f_calib.open("/home/ljj/work/lidar-cam-calibration/lidar-cam-calibration/config/calib_fisheye.yaml",
                 FileStorage::READ);
    if (!f_calib.isOpened()) {
    ...
    for (int i = 0; i < nums; i++) {
        ...
        image_dst = cv::imread("/home/ljj/work/lidar-cam-calibration/lidar-cam-calibration/data/img_fisheye/" +
    ...
    for (int i = 0; i < rotation_vectors.size(); i++) {
        cv::Mat img_dst;
        img_dst = cv::imread("/home/ljj/work/lidar-cam-calibration/lidar-cam-calibration/data/img_fisheye/" +
                             std::to_string(i + 1) + ".png");
        ...
        if (pcl::io::loadPCDFile<pcl::PointXYZ>(
                "/home/ljj/work/lidar-cam-calibration/lidar-cam-calibration/data/pcd_fisheye/" + std::to_string(i + 1) + ".pcd",
