...
int main(int argc, char** argv) {
    ...
    FileStorage f_calib;
    f_calib.open("/home/ljj/work/lidar-cam-calibration/lidar-cam-calibration/config/calib_pinhole.yaml",
                 FileStorage::READ);
    if (!f_calib.isOpened()) {
    ...
    for (int i = 0; i < nums; i++) {
        ...
        cv::Mat image_dst;
        cv::Mat img_dst;
        image = cv::imread("/home/ljj/work/lidar-cam-calibration/lidar-cam-calibration/data/img_pinhole/" +
                           std::to_string(i + 1) + ".png");

        cv::rotate(image, image_dst, cv::ROTATE_90_COUNTERCLOCKWISE);
        img = cv::imread("/home/ljj/work/lidar-cam-calibration/lidar-cam-calibration/data/img_pinhole/" +
                         std::to_string(i + 1) + ".png");
        ...
        if (pcl::io::loadPCDFile<pcl::PointXYZ>(
                "/home/ljj/work/lidar-cam-calibration/lidar-cam-calibration/data/pcd_pinhole/" + std::to_string(i + 1) + ".pcd",
                *cloud_c1) == -1)  
        {
